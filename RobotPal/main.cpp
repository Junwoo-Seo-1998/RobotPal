...
float value;
std::vector<float> my_data = { 1.0f, 2.5f, 1.8f, 3.2f, 2.0f }; // Example data
std::vector<float> print_data = { 1.0f, 2.5f, 1.8f, 3.2f, 2.0f }; // Example data
...
int main(void)
{
...
#endif
    {
        ...
        //write here
        {
            ...
            ImGui::Begin("hello");
            ImGui::SliderFloat("slideme", &value, 0, 1.0);
            ImGui::End();

            

            ImGui::Begin("My Plot Window");
            ImGui::PlotLines("My Line Plot", my_data.data(), my_data.size());
            ImGui::End();
